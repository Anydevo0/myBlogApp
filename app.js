...
// nameserver that doesn't answer DNS SRV queries, which breaks the
// mongodb+srv:// lookup even though the OS resolver works fine. Falling back
// to public DNS avoids that.
...
//   const toDeleteBlog = req.params.postId;
//   console.log(req.params.postId);

//   Post.findOneAndDelete({ _id: toDeleteBlog }).then((post) => {
//     if(!post) {
